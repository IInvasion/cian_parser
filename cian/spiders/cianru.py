...
class CianruSpider(scrapy.Spider):
    ...
    def parse(self, response:HtmlResponse):
        """Entry point."""
        categories_pages = response.xpath('//div[@class="c-popular-links"]//a[@data-name]/@href').extract()
    ...
    def ads_page_parse(self, response:HtmlResponse):
        ...
        ads_links = response.xpath('//article[@data-name="CardComponent"]//div[@data-name="LinkArea"]/a/@href').extract()
